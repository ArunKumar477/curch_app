                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="col-md-10">                           
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                     <input type="text" id="cms_share" name="cms_share" class="form-control" />
                                </div>
                            </div>  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="church_share" name="church_share" class="form-control" />
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="button" id="newOfferingCat" class="btn btn-success">
                                    Save
                                </button>
