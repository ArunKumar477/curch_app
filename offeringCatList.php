<?php 
    ...
    $query = "SELECT * FROM offerings_category where cid=".$_SESSION['cid'];
                    ...
                    <div class="col-lg-12">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"> 
                            <?php 
                                ...
                                $fquery = "SELECT oc.id,oc.category,oc.cms_share,oc.church_share,oc.active,u.name as uname FROM offerings_category oc join users u on oc.created_by = u.id where oc.cid=".$_SESSION['cid']." $limit_data";
                        ...
                        <?php while( $row = mysqli_fetch_assoc($fresult)){ 
                            ...
                            $cms_share   = $row['cms_share'];
                            $church_share   = $row['church_share'];
                            $name   = $row['uname'];
                            $active   = $row['active'];
                        ?>
                            ...
                            <tr>                                
                                <td>                
                                    <span class="uppercase"><?php echo $category; ?> </span>
                                </td>
                                <td>
                                    <span><?php echo $cms_share;?> </span>
                                </td>
                                <td>
                                    <span><?php echo $church_share;?> </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="icons"><a href="offeringCatEdit.php?id=<?php echo $id;?>" id="<?php echo $id;?>"><i class="fa fa-edit"></i></a></span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
