<?php 
    ...
    if(  isset( $_REQUEST['qname'] ) ) {
        $data .= '&name='.$_REQUEST['qname'];
    }

    $name = isset( $_REQUEST['qname'] ) ? $_REQUEST['qname'] : "";
    if( $name != "") {
        $cond .= " AND name LIKE ('%".$name."%')";
    }
    $cid = $_SESSION['cid'];
    $query = "SELECT * FROM members where cid = ".$cid." and active in (1,0)".$cond;
                    ...
                    <div class="col-lg-12">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"> 
                            <?php 
                                ...
                                $fquery = "SELECT * from members where cid= ".$cid." and active in (1,0) $cond $limit_data";                             
                        ...
                        ?>
                            ...
                            <tr>                                
                                ...
                                <td>
                                    <span><?php if( $gender == 'M') { echo 'Male'; } else{ echo 'Female'; } ?> </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span><?php if ( $active ) {  echo 'Yes'; } else{ echo 'No'; } ?> </span>
                                </td>

                                <td>
                                    <span class="icons"><a href="editMember.php?id=<?php echo $id;?>" id="<?php echo $id;?>"><i class="fa fa-edit"></i></a></span>
                                    <span class="icons"><a href="javascript:void(0);" id="<?php echo $id;?>" data-id="<?php echo $id;?>" class="deleteMember"><i class="fa fa-trash"></i></a></span>
                                </td>
                            </tr>
