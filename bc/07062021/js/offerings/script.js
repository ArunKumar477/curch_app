			...
			success: function( response ) {
				...
				if( objData.code == 200 ){
					$.each( objData.data,function( inx, dt ){
						...
						if( cms_share == "50%"){
							cmshare = parseFloat(amt)*50/100;
							cmshare = cmshare.toFixed(2);
						}
						if( cms_share == "100%" ){
							cmshare = parseFloat(amt)*100/100;
							cmshare = cmshare.toFixed(2);
						}

						if( church_share == "50%"){
							crshare = parseFloat(amt)*50/100;
							crshare = crshare.toFixed(2);
						}
						if( church_share == "100%" ){
							crshare = parseFloat(amt)*100/100;	
							crshare = crshare.toFixed(2);
						}
					});					
				}
