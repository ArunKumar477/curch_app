        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="offeringsList.php"><img src="<?php echo $_SESSION['logo'];?>" class="logo" alt="<?php echo $_SESSION['cname'];?>"></a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">                                
                                ...
                                <li>
                                    <a href="customersList.php">Customers</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-group fa-fw"></i>Subscription<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                               <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="customersReport.php">Customers Report</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li> 
